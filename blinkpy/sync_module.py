...
class LocalStorageMediaItem:
    ...
    async def download_video(self, blink: Blink, file_name: str, max_retries: int = 4) -> bool:
    ...
    async def download_video_delete(self, blink: Blink, file_name: str, max_retries: int = 4) -> bool:
